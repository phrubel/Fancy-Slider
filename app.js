...
const KEY = "20265286-e400294a83a48fac7c217089c";
...
const createSlider = () => {
  ...
  const slideDuration = document.getElementById("doration").value;
  ...
  `;
    ...
    confirm("Please set time/valid time for create slide...!!!");
  }
};
...
// key-Board Event Handler(Enter Button)
document
